...
%
% $Id: joinoscars.m,v 1.3 2003/07/17 15:44:00 svoboda Exp $
%
...
scalefactor.cameras = 2;
scalefactor.projectors = 3;
...
for i=1:size(setups,2),
	...
	proj(i*3-2:i*3-1,:) = proj(i*3-2:i*3-1,:)/scalefactors.projectors;
...
Res2(end-2:end,:) = Res2(end-2:end,:)/scalefactors.projectors;
