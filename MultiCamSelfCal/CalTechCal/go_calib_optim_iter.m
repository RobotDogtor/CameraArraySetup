...
%
%%%%%
%% The following note is very important if you use different cameras!!! Then you should clear
%% the already estimated parameters
%%%%%
...
if ~exist('MaxIter'),
    MaxIter = 50; % Maximum number of iterations in the gradient descent
end;

% Leave it 1, otherways some serious problems appear. I do not why for the moment
if ~exist('check_cond'),
